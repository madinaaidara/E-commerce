...
<script src="js/search.js"></script>
    ...
    <!-- Category Header -->
    <section class="category-header" style="background-image: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url('https://images.pexels.com/photos/1340116/pexels-photo-1340116.jpeg');">
        <div class="container">
            <h1>Poudres Naturelles</h1>
        </div>
    </section>
